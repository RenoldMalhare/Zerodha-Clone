...
function Brokrage() {
  return (
    <div className="container">
      <div className="row">
        <h1 className="fs-3 pb-2">Charges explained</h1>
      </div>
      <div className="row">
        <div className="col">
          <p className="fs-5 pt-4">Securities/Commodities transaction tax</p>
      ...
      <div className="row mb-5">
        <p className="fs-5 pt-4">Disclaimer</p>
        <p style={{ fontSize: "14px" }}>
